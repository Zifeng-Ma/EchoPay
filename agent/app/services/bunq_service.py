...
try:
    from bunq_client import BunqClient  # type: ignore[import-not-found]  # noqa: E402
except ModuleNotFoundError:  # pragma: no cover - depends on local bunq checkout
